...
static const BYTE	MP4_sigHEADER1[8]		= {0x66, 0x74, 0x79, 0x79};					// offset : 4 "ftyp" 
static const BYTE	MP4_sigHEADER2[8]		= {0x66, 0x74, 0x79, 0x79, 0x33, 0x67, 0x70, 0x35};	// offset : 4 "ftyp3gp5" 
...
static const CHAR	*XML_sigHEADER1			= "<?xml";
static const CHAR	*XML_sigHEADER2			= "<?XML";
...
// Text
// Lower & Upper Bound of Ascii
#define LowerBound_ASCII	0x20
#define UpperBound_ASCII	0x7E

// Lower & Upper Bound of UTF8
#define LowerBound_UTF8_kor 0xEAB080
#define UpperBound_UTF8_kor 0xED9EA3
